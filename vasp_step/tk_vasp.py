...
class TkVASP(seamm.TkNode):
    ...
    self[widget] : dict
        ...
        contained in VASP_parameters.py
    ...
    def __init__(
        ...
        tk_flowchart=None,
        node=None,
        namespace="org.molssi.seamm.vasp.tk",
        canvas=None,
        x=None,
        y=None,
        w=200,
    ...
    def create_dialog(self):
        ...
        based on what is specified in the VASP_parameters
        module.
        ...
        frame = super().create_dialog(title="VASP")
        # make it large!
